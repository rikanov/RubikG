...
bool UnitTests::unit_CFramework() const
{
  ...
  clog_( Color::white, Color::uline, "Start Simplex instance..." );
  Simplex::instance();
  clog( "Done." );

  clog_( Color::white, Color::uline, "Start 'cube positions' instances..." );
  ...
  clog_( Color::white, Color::uline, "Cube framework test..." );
  ...
  clog( Color::white, Color::uline, "Test case 5 :", Color::off, "revert of T4 --> Z4, Z4, Z4, Y1, Y1, X1, X1, X1" );
  CFramework<5> test5;
  test5.rot( _Z, 4 );
  test5.rot( _Z, 4 );
  test5.rot( _Z, 4 );
  ...
  clog( Color::white, Color::uline, "Test case 6 :", Color::off, "combine of T3 + T4 --> solved cube" );
  CFramework<5> test6(test3,test4);
  test6.print();
  
  clog( Color::white, Color::uline, "Test case 7 :", Color::off, "combine of T3 + T5 --> solved cube" );
